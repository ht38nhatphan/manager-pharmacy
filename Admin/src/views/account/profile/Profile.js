          ...
          <div className="card">
            <div className="card-body pt-3">
              ...
              <ul className="nav nav-tabs nav-tabs-bordered" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                  <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" aria-selected="false" role="tab" tabIndex={-1}>Edit Profile</button>
                </li>
                <li className="nav-item" role="presentation">
                  <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" aria-selected="false" role="tab" tabIndex={-1}>Settings</button>
                </li>
                <li className="nav-item" role="presentation">
